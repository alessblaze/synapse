            ...
            def wrapped_callback(*args: Any, **kwargs: Any) -> None:
                ...
                try:
                    ...
                    if track_for_shutdown_cancellation:
                        ...
                        # the callback raises an exception. Use pop with default to avoid KeyError
                        # if cancel() already removed the entry during a race condition.
...
class DelayedCallWrapper:
    ...
    def cancel(self) -> None:
        ...
        try:
            ...
            # Ignore AlreadyCalled and other cancellation errors during shutdown
            pass
        try:
